...
ActiveRecord::Schema.define(version: 2022_01_22_155015) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["business_unit_slot_id", "order_date"], name: "index_orders_on_business_unit_slot_id_and_order_date", unique: true, where: "finished"
