module Admin
  class BusinessUnitSlotsController < ApplicationController
    ...
    def create
      ...
      if result.success?
        redirect_to admin_business_unit_slots_path, notice: I18n.t('admin.slots.notices.created_at')
      else
    ...
    def update
      ...
      if result.success?
        redirect_to admin_business_unit_slots_path, notice: I18n.t('admin.slots.notices.updated_at')
      else
    ...
    def destroy
      ...
      if result.success?
        redirect_to admin_business_unit_slots_path, notice: I18n.t('admin.slots.notices.deleted_at')
      end
    end
